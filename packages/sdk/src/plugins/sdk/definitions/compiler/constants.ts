// Generated from packages/plugin-runtime/src/definitions/compiler/constants.ts. Do not edit; run the Octonode SDK sync.
...
export const DEFINITION_MODULES = ["@octonodes/sdk", "@octonode/plugin-runtime", "@octonode/sdk"].flatMap((scope) =>
